...
/*
 * Case 9 : Default constructor; various inserts; delete last node; getSize and isEmpty; print.
 */
int main() {
    ...
    std::cout << "-> Deleting the last node from the list and then printing the list." << std::endl;

    llist.deleteNode(llist.getActualTail());
