...
/*
 * Case 8 : Default constructor; various inserts; delete first node; getSize and isEmpty; print.
 */
int main() {
    ...
    std::cout << "-> Deleting the first node from the list and then printing the list." << std::endl;
